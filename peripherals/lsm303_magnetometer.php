<?php
	...
	class lsm303_magnetometer extends i2c_bus {
		...
		public function get_fields() {
			$this->fields['x'] = $this->read_signed_short( $this->out_x_l, $this->out_x_h );
			$this->fields['y'] = $this->read_signed_short( $this->out_y_l, $this->out_y_h );
			$this->fields['z'] = $this->read_signed_short( $this->out_z_l, $this->out_z_h );
			return $this->fields;
		}
